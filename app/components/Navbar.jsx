...
const NavbarAdmin = () => {
    ...
    return (
            <nav className='flex flex-col justify-bettween items-center rounded-full m-4  group-hover:items-baseline group-hover:pl-4  w-16  py-8 bg-black  mr-3 p-1.5  h-full my-24 justify-center'>

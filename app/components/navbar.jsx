...
const NavbarAdmin = () => {
    ...
    return (
            <nav className='flex flex-col justify-bettween items-center rounded-full m-4  group-hover:items-baseline group-hover:pl-4  w-16  py-8 bg-black  mr-3 p-1.5  h-full my-24 justify-center items-center'>
                <ul className='flex gap-2 flex-col justify-center items-center py-2'>
                    <li className='w-fit h-12 flex hover:bg-yellow-500 rounded justify-center items-center w-10 h-10 group-hover:w-full gap-4'>
                        <Link href={'/admin/dashboard'}>
                            <svg class="w-10 h-10 text-yellow-300 dark:text-white hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li className='w-fit h-12 flex hover:bg-yellow-500 rounded justify-center items-center w-12 h-12 group-hover:w-full gap-4'>
                    ...
                    <li className='w-fit h-12 flex hover:bg-yellow-500 rounded justify-center items-center w-11 h-11 group-hover:w-full gap-4'>
                    ...
                    <li className='w-fit h-12 flex hover:bg-yellow-500 rounded justify-center items-center w-11 h-11 group-hover:w-full gap-4'>
                        <Link href={'/pagos'}>
                            <svg class="w-10 h-10 text-yellow-300 dark:text-white hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 24 24">
